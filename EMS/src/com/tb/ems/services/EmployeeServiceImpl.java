...
public class EmployeeServiceImpl implements IEmployeeService
{
	...
	/**
	 * This function adds a new manager to the list. It calls the in-built
	 * function add to add a manager to the list.
	...
	/**
	 * This function adds a new engineer to the list. It calls the in-built
	 * function add to add an engineer to the list.
	 * @param employee parameter of the Employee bean.
	 * @exception UnsupportedOperationException Thrown to indicate that the
	 * requested operation is not supported.
	 * @exception ClassCastException Thrown to indicate that the code has attempted to
